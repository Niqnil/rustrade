...
/// [`Validator`](rustrade_integration::Validator) for [`Coinbase`].
...
/// Convenient type alias for a Coinbase [`ExchangeWsStream`] using [`WebSocketSerdeParser`](rustrade_integration::protocol::websocket::WebSocketSerdeParser).

...
use rustrade_integration::{serde::de::extract_next, subscription::SubscriptionId};
use serde::Serialize;

/// [`Bitfinex`](super::Bitfinex) message received over
/// [`WebSocket`](rustrade_integration::protocol::websocket::WebSocket) relating to an active

...
/// [`Validator`](rustrade_integration::Validator) for [`Bitfinex`].
...
/// Convenient type alias for a Bitfinex [`ExchangeWsStream`] using [`WebSocketSerdeParser`](rustrade_integration::protocol::websocket::WebSocketSerdeParser).

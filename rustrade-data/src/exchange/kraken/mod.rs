...
/// [`Validator`](rustrade_integration) for [`Kraken`].
...
/// Convenient type alias for a Kraken [`ExchangeWsStream`] using [`WebSocketSerdeParser`](rustrade_integration::protocol::websocket::WebSocketSerdeParser).
